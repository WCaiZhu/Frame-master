...
object DateUtils {
    ...
    /** 格式化[formatType]当前时间 */
    @JvmStatic
    fun getCurrentFormatString(formatType: String): String =
        getFormatString(formatType, Date(System.currentTimeMillis()))
    ...
    @JvmStatic
    fun getFormatMilliseconds(formatType: String, milliseconds: Long): String =
        getFormatString(formatType, Date(milliseconds))
